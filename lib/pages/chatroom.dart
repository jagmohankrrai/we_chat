...
import '../main.dart';
import '../model/masgmodel.dart';
import '../model/users.dart';
import '../model/chastmodel.dart';
class ChatRoomPage extends StatefulWidget {
  final users targetUser;
  final chastmodel chatroom;
...
class _ChatRoomPageState extends State<ChatRoomPage> {
  ...
  void sendMessage() async {
    ...
    if(msg != "") {
      ...
      FirebaseFirestore.instance.collection("chatrooms").doc(widget.chatroom.roomid).collection("messages").doc(newMessage.messageid).set(newMessage.toMap());

      widget.chatroom.lastmsg = msg;
      FirebaseFirestore.instance.collection("chatrooms").doc(widget.chatroom.roomid).set(widget.chatroom.toMap());
        ...
        title: Row(
          children: [
            ...
            CircleAvatar(
              ...
              backgroundImage: NetworkImage(widget.targetUser.dp.toString()),
            ),

            SizedBox(width: 10,),

            Text(widget.targetUser.full_name.toString()),
            ...
            children: [
              ...
              Expanded(
                child: Container(
                  ...
                  child: StreamBuilder(
                    stream: FirebaseFirestore.instance.collection("chatrooms").doc(widget.chatroom.roomid).collection("messages").orderBy("createdon", descending: true).snapshots(),
